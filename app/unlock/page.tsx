  ...
  return (
    <>
      ...
      border-white/30 shadow-xl text-white text-3xl glowing-button mb-2 p-3">
            ...
            <div className="bg-[url('/images/menus/cardbio.jpg')] overflow-hidden bg-cover bg-center bg-no-repeat text-xl bg-white/30 rounded-3xl font-bold text-white text-center">
              <div className="inset-0 bg-indigo-300/30 p-8">
