...
export default function Home() {
  return (
    <>
      ...
      <main className="fixed inset-0 min-h-screen bg-[url('/images/home.webp')] bg-cover bg-center bg-no-repeat
      bg-black text-white flex flex-col items-center justify-center p-8 overflow-hidden ">
        ...
        <div className="flex flex-col items-center gap-4 mb-10 z-10">
          <Link href="/login?querymode=login">
            <button className="bg-white text-black px-6 mt-8 py-3 rounded-2xl font-bold 
        ...
        <div className="flex flex-center gap-4 mt-6 text-sm rounded-3xl bg-black/50 p-3 z-10">
