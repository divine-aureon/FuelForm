...
export default function Home() {
  return (
    ...
    <HomeBackgroundSetter />
      ...
      <div className="h-[80dvh] grid grid-cols-1">
        
        
        <div className="bg-black/40 rounded-3xl mt-[140px] p-4">
          <h1 className="text-7xl md:text-7xl font-extrabold text-center  z-10">
            FuelForm
          </h1>
        ...
        <div className="flex text-center grid grid-cols-1 gap-3 mt-[140px] z-10">
          <Link href="/login?querymode=login">
            <button className="w-32 bg-white text-black px-4 py-3 rounded-2xl font-bold 
          ...
          <Link href="/login?querymode=register">
            <button className="w-32 bg-gray-800 text-white px-4 py-3 rounded-2xl font-bold border 
            border-white hover:shadow-lg hover:shadow-pink-400/40 transition duration-300 w-full">
              Sign Up
            </button>
          </Link>
        </div>
        <div className="flex justify-center mt-[100px] h-[50px]">
