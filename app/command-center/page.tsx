      ...
      <div className="relative z-0 pb-10">
        ...
        border-white/30 shadow-xl text-white text-2xl glowing-button">
          ...
          <div className="flex flex-col  gap-4 py-3">
            <button className="w-full rounded-xl py-4 hidden leading-none bg-white/20 justify-center flex flex-col items-center backdrop-blur hover:bg-indigo-300/50 text-white shadow-md"
