...
import ModalFadeWrapper from "@/Backgrounds/PageFadeWrapper"
...
export function BioModal({ onClose, children }: BioModalProps) {
  return (
    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center overflow-hidden">
      ...
      />
      {/* Modal */}
      <div className="relative z-60 max-w-md w-full rounded-xl max-h-screen scrollbar-hide overflow-hidden p-2 pb-20">
        <button
          onClick={onClose}
