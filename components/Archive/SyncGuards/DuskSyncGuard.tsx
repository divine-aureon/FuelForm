...
export default function DuskSyncGuard() {

  const { hasDuskSyncedToday } = TodaysSync();

  if (!hasDuskSyncedToday) return null;

  return (
    <div className="fixed inset-0 z-30 bg-black/30 flex items-center justify-center text-white text-center px-4">
      <div className="bg-white/10 backdrop-blur p-6 rounded-xl shadow-xl max-w-md">
        ...
        <p>Initiate DuskSync Override to Sync</p>
        <button
