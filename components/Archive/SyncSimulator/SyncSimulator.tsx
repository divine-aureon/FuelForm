...
export default function SyncSimulator() {
    ...
    return (
        <main className=" rounded-lg bg-blue-600/30 w-full mb-24">
            <div className=" max-w-md text-center">
                <div className="bg-[url('/images/hologram.gif')] bg-cover bg-center bg-no-repeat bg-blue-500/30 bg rounded-xl overflow-hidden">
