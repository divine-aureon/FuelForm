...
export default function MacroVaultTile({ isPaidUser }: { isPaidUser: boolean }) {
        ...
        border-white/30 shadow-xl text-white glowing-button"
                        >
                            <div
                                ...
                                <h2 className="text-sm font-bold text-white">Nourish. Record. Repeat.</h2>
                            </div>
                        </div>
                    </Link>
                ...
                <>
                    ...
                    <Link href="/macrovault">
                        <div
                            ref={ref}
                            className="relative h-32 bg-[url('/images/menus/meals3.jpg')] bg-cover bg-center bg-no-repeat rounded-2xl border 
        border-white/30 shadow-xl text-white glowing-button"
                        >
